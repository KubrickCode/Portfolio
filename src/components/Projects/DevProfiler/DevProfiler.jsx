...
const goals = [
  ...
  },
  {
    id: 2,
    description:
      "좀더 깔끔한 방식의 계층형 아키텍처를 우선적으로 공부하는 것이 목표.",
  },
  {
    id: 3,
    description:
  ...
  },
  {
    id: 4,
    description:
      "여태 API명세에 대한 문서화가 전혀 없었는데, 협업 과정에서 특히나 필요함을 느꼈으므로 Swagger에 대한 학습 또한 목표.",
  },
  {
    id: 5,
    description:
      "추가적으로 테스트 주도 개발에 대한 중요성은 두루뭉실하게 들어만 왔지, 정확히 어떻게 하는지 혹은 어떠한 이점을 가지는 지에 대해 모르고 있었으므로, 일단 무작정 테스트를 적용해보는 것 또한 목표.",
  },
];
...
const features = [
  ...
  },
  {
    id: 1,
    description:
      "로컬과 소셜방식의 로그인이 가능하고, 역량 검사 결과를 저장할 수 있음.",
  },
  {
    id: 2,
    description:
      "추가적으로 역량 검사 데이터 덮어쓰기, 삭제, 회원정보 변경, 탈퇴, 다크모드 등 구현.",
  },
];

...
const features = [
  ...
  {
    id: 6,
    description: "관리자 페이지를 통해 뱃지, 유저 등 제어 가능",
  },
];
...
const goals = [
  ...
  },
  {
    id: 5,
    description:
      "회원 인증과 JWT, 그리고 일어날 수 있는 각종 보안 문제들에 대해 고민하고 해결하기",
  },
  {
    id: 6,
    description:
      "HTTP의 메서드와 상태코드에 대해 심도 있게 공부하고 적절하게 REST API 설계하기",
  },
  {
    id: 7,
    description: "DTO와 직렬화, 역직렬화 등에 대해 심도있게 고민하고 적용하기",
  },
  {
    id: 8,
    description:
      "기존에 사용하지 않던 로깅, 캐싱, 쓰로틀링 등을 프로젝트에 접목시켜볼 것",
  },
];

...
import FolioverseReport from "./FolioverseReport";
...
const about = [
  { id: 0, description: "첫 번째 팀 프로젝트" },
  { id: 1, description: "포트폴리오 제작 및 공유 웹사이트" },
  {
    id: 2,
    description:
...
const skills = [
  ...
  {
    id: 2,
    description: "포트폴리오의 필수 MVP 및 추가 MVP 구현(프론트,백엔드 통합).",
  },
  {
    id: 3,
    description:
      "회원 프로필, 회원 정보 설정, 프로필 사진, 좋아요 및 팔로우, 통계 데이터 등 구현 (프론트,백엔드 통합).",
  },
  {
    id: 4,
    description:
  ...
  {
    id: 7,
    description: "AWS SES를 통한 메일 서비스(비밀번호 찾기) 구현.",
  },
  {
    id: 8,
    description:
...
const features = [
  ...
  },
  {
    id: 1,
    description:
      "로컬과 소셜 방식의 로그인이 가능하고, 로그인 시 나의 포트폴리오를 제작 및 공유할 수 있음.",
  },
  {
    id: 2,
    description: "유저 간 좋아요, 팔로우 등의 소셜 기능이 가능.",
  },
  {
    id: 3,
    description:
  ...
  },
  {
    id: 4,
    description:
      "포트폴리오 작성만으로는 부족한 정보들에 대해 미니 블로깅 서비스를 통해 간단한 글 게시 가능 및 다른 유저 열람 가능.",
  },
  {
    id: 5,
    description:
  ...
  {
    id: 7,
    description: "이름, 한 줄 소개, 프로필 사진 등 회원 프로필 수정 가능.",
  },
  {
    id: 8,
    description: "비밀번호, 회원 탈퇴 등 회원정보 수정 가능.",
  },
  {
    id: 9,
    description:
...
const articleList = [
  ...
  },
  {
    id: 5,
    title: "회고",
    description: <FolioverseReport />,
  },
];

export default Folioverse;
